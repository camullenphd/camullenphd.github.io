  ...
  _createClass(NetCreate, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { hidden: this.state.isConnected, style: { width: '100%', height: '38px', position: 'fixed', backgroundColor: 'rgba(256,0,0,0.5', display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'center', zIndex: '3000' } },
          React.createElement(
            'div',
  ...
  _createClass(EdgeTable, [{
    ...
    value: function sortByID(edges) {
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          var akey = a.id,
              bkey = b.id;
          if (akey < bkey) return -1 * _this3.sortDirection;
          if (akey > bkey) return 1 * _this3.sortDirection;
          return 0;
        });
      }
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          var akey = a.source.label,
              bkey = b.source.label;
          return akey.localeCompare(bkey) * _this4.sortDirection;
        });
      }
      return undefined;
    }
    ...
    value: function sortByAttribute(edges, key) {
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          ...
          if (akey < bkey) return -1 * _this6.sortDirection;
          if (akey > bkey) return 1 * _this6.sortDirection;
          if (akey === bkey) {
            // Secondary sort on Source label
            var source_a = a.source.label;
            var source_b = b.source.label;
            if (source_a < source_b) return -1 * _this6.sortDirection;
            if (source_a > source_b) return 1 * _this6.sortDirection;
          }
          return 0;
        });
    ...
    value: function sortByUpdated(edges) {
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          ...
          if (akey < bkey) return -1 * _this7.sortDirection;
          if (akey > bkey) return 1 * _this7.sortDirection;
          return 0;
        });
      }
    ...
    value: function sortSymbol(key) {
      if (key != this.state.sortkey) // this is not the current sort, so don't show anything
        return "";else return this.sortDirection == -1 ? "▼" : "▲"; // default to "decreasing" and flip if clicked again
    }
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("source");
                    }
                  },
                  edgePrompts.source.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("Relationship");
                    }
                  },
                  edgePrompts.type.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("target");
                    }
                  },
                  edgePrompts.target.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("Category");
                    }
                  },
                  edgePrompts.category.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("Citations");
                    }
                  },
                  edgePrompts.citation.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("Notes");
                    }
                  },
                  edgePrompts.notes.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("Updated");
                    }
                  },
                  'Updated ',
              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'a',
                    { href: '#', onClick: function onClick(e) {
                        return _this8.selectNode(edge.source.id, e);
                      }
                    },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'a',
                    { href: '#', onClick: function onClick(e) {
                        return _this8.selectNode(edge.target.id, e);
                      }
                    },
...
var FiltersPanel = require('./filter/FiltersPanel');
...
var InfoPanel = function (_UNISYS$Component) {
  ...
  _createClass(InfoPanel, [{
    ...
    value: function handleDrag(e) {
      ...
      var top = Math.max(120, e.clientY + this.state.draggerMouseOffsetY);
      this.setState({
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          bIgnoreTableUpdates = _state.bIgnoreTableUpdates,
      ...
      return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('2');_this2.sendGA('Highlight', window.location);
                  }
                },
                'Highlight / Filter'
              )
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('5');_this2.sendGA('Vocabulary', window.location);
                  }
                },
                'Vocabulary'
              )
          ...
          React.createElement(
            ...
            React.createElement(
              TabPane,
              { tabId: '2' },
              React.createElement(FiltersPanel, { tableHeight: tableHeight })
            ),
            React.createElement(
              TabPane,
              { tabId: '3' },
              React.createElement(
                ...
                React.createElement(
                  Col,
                  { sm: '12' },
                  activeTab === "3" && React.createElement(NodeTable, { tableHeight: tableHeight, bIgnoreTableUpdates: bIgnoreTableUpdates })
                )
              )
            ),
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Col,
                  { sm: '12' },
                  activeTab === "4" && React.createElement(EdgeTable, { tableHeight: tableHeight, bIgnoreTableUpdates: bIgnoreTableUpdates })
                )
              )
            ),
            React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { size: 'sm', outline: true, onClick: this.OnClearBtnClick },
            'Clear Filters'
          )
        )
      );
  ...
  _createClass(NodeSelector, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          FormGroup,
          { className: 'text-right', style: { marginTop: '-35px', paddingRight: '5px' } },
          React.createElement(
            Button,
            { outline: true, size: 'sm',
      ...
      if (nodes) {
        return nodes.sort(function (a, b) {
          var akey = a.degrees || 0,
              bkey = b.degrees || 0;
          // sort descending
          if (akey > bkey) return 1 * _this4.sortDirection;
          if (akey < bkey) return -1 * _this4.sortDirection;
          return 0;
        });
      }
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("edgeCount");
                    }
                  },
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this8.setSortKey("label");
                    }
                  },
                  nodePrompts.label.label,
                  ' ',
              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'a',
                    { href: '#', onClick: function onClick(e) {
                        return _this8.selectNode(node.id, e);
                      }
                    },
                    node.label
                  )
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Label,
            { style: { float: 'left' }, className: 'small text-muted' },
