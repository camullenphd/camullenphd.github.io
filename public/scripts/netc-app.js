  ...
  _createClass(AppShell, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          Navbar,
          { fixed: 'top', light: true, expand: 'md', style: { backgroundColor: '#f0f0f0', padding: '4px 10px' } },
          React.createElement(
            NavbarBrand,
            { href: '#', style: { padding: '0' } },
            React.createElement('img', { src: 'images/netcreate-logo.svg', height: '26px' })
          ),
          React.createElement(NavbarToggler, { onClick: this.toggle }),
          React.createElement(
            Collapse,
            { isOpen: this.state.isOpen, navbar: true },
            React.createElement(Nav, { className: 'ml-auto', navbar: true, hidden: !isLocalHost })
          )
        ),
...
SESUTIL.DecodeToken = function (token, dataset) {
  ...
  var salt = "" + classId + projId + dataset;
...
SESUTIL.IsValidToken = function (token, dataset) {
  var decoded = SESUTIL.DecodeToken(token, dataset);
...
var SessionShell = function (_UNISYS$Component) {
  ...
  function SessionShell() {
    ...
    _this.state = { // `state` tracks the login input field
      token: null,
      classId: null,
      projId: null,
      hashedId: null,
  ...
  _createClass(SessionShell, [{
    ...
    value: function renderLogin() {
      ...
      if (groupId) {
        if (subId === 0) {
          ...
          formFeedback = React.createElement(
            FormFeedback,
            { style: NAV_LOGIN_FEEDBACK_STYLE, className: "text-right" },
            React.createElement(
              "small",
              null,
              tip
          ...
          formFeedback = React.createElement(
            FormFeedback,
            { valid: true, style: NAV_LOGIN_FEEDBACK_STYLE, className: "text-right" },
            React.createElement(
              "small",
              null,
              tip
      ...
      return React.createElement(
        Form,
        { onSubmit: this.onSubmit, style: NAV_LOGIN_STYLE },
        React.createElement(
          FormGroup,
          { row: true },
          React.createElement(
    ...
    value: function componentWillMount() {
      ...
      var decoded = SESSION.DecodeToken(token, window.NC_CONFIG.dataset) || {};
      this.SetAppState("SESSION", decoded);
...
var m_locked_edges = void 0; // map key = nodeID, value = uaddr initiating the lock
var TEMPLATE = void 0;
...
var FiltersPanel = require('./components/filter/FiltersPanel');
var NCLOGIC = require('./nc-logic'); // require to bootstrap data loading
var FILTERLOGIC = require('./filter-logic'); // handles filtering functions
...
var NetCreate = function (_UNISYS$Component) {
  ...
  function NetCreate() {
    ...
    var UDATA = UNISYS.NewDataLink(_this);
    UDATA.HandleMessage("DISCONNECT", _this.onDisconnect);
    return _this;
  }
  ...
  _createClass(NetCreate, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { hidden: this.state.isConnected, style: {
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { id: 'left', style: { backgroundColor: '#EEE', flex: '1 1 25%', maxWidth: '400px', padding: '10px', overflow: 'scroll', marginTop: '38px' } },
            React.createElement(
              'div',
              { style: { display: 'flex', flexFlow: 'column nowrap' } },
          ...
          React.createElement(
            'div',
            { id: 'middle', style: { backgroundColor: '#fcfcfc', flex: '3 0 60%', marginTop: '38px' } },
            React.createElement(InfoPanel, null),
            React.createElement(NetGraph, null),
            React.createElement(
              'div',
              { style: { fontSize: '10px', position: 'fixed', left: '0px', bottom: '0px', right: '0px', zIndex: '1500', color: '#aaa', backgroundColor: '#eee', padding: '5px 10px' } },
          ...
          ? React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(FiltersPanel, null)
            )
          )
          // CLOSED
          : React.createElement(
...
var EdgeEditor = function (_UNISYS$Component) {
  ...
  function EdgeEditor(props) {
    ...
    _this.state = {
      ...
      citationPrompts: _this.AppState('TEMPLATE').citationPrompts,
    ...
    /// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    UDATA.HandleMessage('EDGE_CLOSE', function (data) {
      if (_this.state.isExpanded) _this.setState({ isExpanded: false });
    });
  ...
  _createClass(EdgeEditor, [{
    ...
    value: function loadSourceAndTarget() {
      ...
      if (edge === undefined) {
        ...
        edge = {
          ...
          _this2.AppCall('AUTOCOMPLETE_SELECT', { id: 'edge' + _this2.props.edgeID + 'target' });
        });
    ...
    value: function onEdgeClick() {
      ...
      if (this.state.isExpanded) {
        ...
        if (this.state.isEditable) {
          ...
          var originalEdge = D3DATA.edges.filter(function (edge) {
            return parseInt(edge.id) === _this4.props.edgeID;
          })[0];
          if (originalEdge === undefined) {
            // user abandoned editing a new node that was never saved
            var parentNode = D3DATA.nodes.find(function (node) {
              return node.label === _this4.props.parentNodeLabel;
            });
    ...
    value: function onSubmit(event) {
      ...
      if (edge) {
        ...
        var source = D3DATA.nodes.find(function (node) {
        ...
        // check target
        var target = D3DATA.nodes.find(function (node) {
    ...
    value: function render() {
      ...
      var citationPrompts = this.state.citationPrompts;
      ...
      if (citationPrompts === undefined) {
        // if citationPrompts were left out, simply make them hidden
        citationPrompts = {};
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    this.helpText(edgePrompts.source)
                  )
                )
              ),
              React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'tooltiptext' },
                    this.helpText(edgePrompts.type)
                  )
                )
              ),
              React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'tooltiptext' },
                    this.helpText(edgePrompts.target)
                  )
                )
              ),
              React.createElement(
            ...
            React.createElement(
              FormGroup,
              { row: true, hidden: edgePrompts.category.hidden },
              React.createElement(
                Col,
                { sm: 3, style: { hyphens: 'auto' }, className: 'pr-0' },
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'tooltiptext' },
                    this.helpText(edgePrompts.category)
                  )
                )
              ),
              React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'tooltiptext' },
                    this.helpText(edgePrompts.citation)
                  )
                )
              ),
              React.createElement(
                Col,
                { sm: 9 },
                React.createElement(Input, { type: 'text', name: 'citation',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'tooltiptext' },
                    this.helpText(edgePrompts.notes)
                  )
                )
              ),
              React.createElement(
                Col,
                { sm: 9 },
                React.createElement(Input, { type: 'textarea', name: 'notes',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'tooltiptext' },
                    this.helpText(edgePrompts.info)
                  )
                )
              ),
              React.createElement(
                Col,
                { sm: 9 },
                React.createElement(Input, { type: 'text', name: 'info',
                  value: formData.info,
            ...
            React.createElement(
              'div',
              { id: 'citationWindow', hidden: this.state.hideModal, className: 'modal-content' },
              React.createElement(
                'span',
            ...
            React.createElement(
              ...
              React.createElement(
                Button,
                { className: 'small float-left btn btn-outline-light', size: 'sm',
    ...
    value: function markdownDisplay(text) {
      if (!this.state.isEditable) {
        return (0, _markdownReactJs.mdReact)({
...
var MarkdownNote = require('./MarkdownNote');
...
var EdgeTable = function (_UNISYS$Component) {
  ...
  function EdgeTable(props) {
    ...
    // Always make sure class methods are bind()'d before using them
    // as a handler, otherwise object context is lost
    _this.OnAppStateChange('D3DATA', _this.handleDataUpdate);

    // Handle Template updates
    _this.OnAppStateChange('TEMPLATE', _this.OnTemplateUpdate);

    // Track Filtered Data Updates too
    _this.OnAppStateChange('FILTEREDD3DATA', _this.handleFilterDataUpdate);
  ...
  _createClass(EdgeTable, [{
    ...
    value: function componentDidMount() {
      ...
      var FILTEREDD3DATA = UDATA.AppState('FILTEREDD3DATA');
      this.setState({ filteredEdges: FILTEREDD3DATA.edges }, function () {
        var D3DATA = _this2.AppState('D3DATA');
        _this2.handleDataUpdate(D3DATA);
      });
    }
  }, {
    key: 'componentWillUnmount',
    ...
    value: function handleDataUpdate(data) {
      if (data && data.edges) {
        var edges = this.sortTable(this.state.sortkey, data.edges);
        var filteredEdges = this.state.filteredEdges;
    ...
    value: function handleFilterDataUpdate(data) {
      ...
      if (data.edges) {
        ...
        this.setState({ filteredEdges: filteredEdges }, function () {
          var edges = _this3.sortTable(_this3.state.sortkey, _this3.state.edges);
    ...
    value: function sortByID(edges) {
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          var akey = a.id,
              bkey = b.id;
          if (akey < bkey) return -1 * Number(_this4.sortDirection);
          if (akey > bkey) return 1 * Number(_this4.sortDirection);
          return 0;
        });
      }
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          var akey = a.source.label,
              bkey = b.source.label;
          return akey.localeCompare(bkey) * _this5.sortDirection;
        });
      }
      return undefined;
    }
    ...
    value: function sortByTargetLabel(edges) {
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          ...
          return akey.localeCompare(bkey) * _this6.sortDirection;
        });
      }
      return undefined;
    }
    ...
    value: function sortByAttribute(edges, key) {
      ...
      if (edges) {
        return edges.sort(function (a, b) {
          ...
          if (akey < bkey) return -1 * Number(_this7.sortDirection);
          if (akey > bkey) return 1 * Number(_this7.sortDirection);
          if (akey === bkey) {
            // Secondary sort on Source label
            var source_a = a.source.label;
            var source_b = b.source.label;
            if (source_a < source_b) return -1 * Number(_this7.sortDirection);
            if (source_a > source_b) return 1 * Number(_this7.sortDirection);
          }
          return 0;
        });
    ...
    value: function setSortKey(key) {
      ...
      var edges = this.sortTable(key, this.state.edges);
      this.setState({
        edges: edges,
        sortkey: key
      });
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("source");
                    }
                  },
                  edgePrompts.source.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("Relationship");
                    }
                  },
                  edgePrompts.type.label,
                  ' ',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("target");
                    }
                  },
                  edgePrompts.target.label,
                  ' ',
              ...
              React.createElement(
                'th',
                { width: '8%', hidden: edgePrompts.category.hidden },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("Category");
                    }
                  },
                  edgePrompts.category.label,
                  ' ',
                  this.sortSymbol("Category")
                )
              ),
              React.createElement(
                'th',
                { width: '10%', hidden: edgePrompts.citation.hidden },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("Citations");
                    }
                  },
                  edgePrompts.citation.label,
                  ' ',
                  this.sortSymbol("Citations")
                )
              ),
              React.createElement(
                'th',
                { width: '20%', hidden: edgePrompts.notes.hidden },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("Notes");
                    }
                  },
                  edgePrompts.notes.label,
                  ' ',
                  this.sortSymbol("Notes")
                )
              ),
              React.createElement(
                'th',
                { width: '10%', hidden: edgePrompts.info.hidden },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("Info");
                    }
                  },
                  edgePrompts.info.label,
                  ' ',
                  this.sortSymbol("Info")
                )
              ),
              React.createElement(
                'th',
                { width: '10%', hidden: !isLocalHost },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("Updated");
                    }
                  },
                  'Updated ',
                  this.sortSymbol("Updated")
                )
              )
            )
          ),
              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'a',
                    { href: '#', onClick: function onClick(e) {
                        return _this9.selectNode(edge.source.id, e);
                      }
                    },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'a',
                    { href: '#', onClick: function onClick(e) {
                        return _this9.selectNode(edge.target.id, e);
                      }
                    },
                ...
                React.createElement(
                  'td',
                  { hidden: edgePrompts.category.hidden },
                ...
                React.createElement(
                  ...
                  edge.attributes["Notes"] ? React.createElement(MarkdownNote, { text: edge.attributes["Notes"] }) : ""
                ),
                React.createElement(
                  'td',
...
require.register("view/netcreate/components/ImportExport.jsx", function(exports, require, module) {
'use strict';
...
var ImportExport = function (_UNISYS$Component) {
  _inherits(ImportExport, _UNISYS$Component);
  ...
  function ImportExport(props) {
    ...
    _this.onSelectExportNodes = _this.onSelectExportNodes.bind(_this);
    _this.onSelectExportEdges = _this.onSelectExportEdges.bind(_this);
    _this.onSelectImportNodes = _this.onSelectImportNodes.bind(_this);
    _this.onSelectImportEdges = _this.onSelectImportEdges.bind(_this);
  ...
  _createClass(ImportExport, [{
    key: 'onSelectExportNodes',
    value: function onSelectExportNodes() {
      UDATA.LocalCall('EXPORT_NODES');
    }
  }, {
    key: 'onSelectExportEdges',
    value: function onSelectExportEdges() {
      UDATA.LocalCall('EXPORT_EDGES');
    }
  }, {
    key: 'onSelectImportNodes',
    value: function onSelectImportNodes() {}
  }, {
    key: 'onSelectImportEdges',
    value: function onSelectImportEdges() {}
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          Button,
          { size: 'sm', outline: true, onClick: this.onSelectExportNodes },
          'Export Nodes'
        ),
        '\xA0',
        React.createElement(
          Button,
          { size: 'sm', outline: true, onClick: this.onSelectExportEdges },
          'Export Edges'
        ),
        '\xA0',
        React.createElement(
        ...
        React.createElement(
          Button,
          { size: 'sm', outline: true, disabled: true, onClick: this.onSelectExportNodes },
          'Import Nodes'
        ),
        '\xA0',
        React.createElement(
...
var defaultTabPanelHeight = 42; // show only tab buttons, no gap
...
var InfoPanel = function (_UNISYS$Component) {
  ...
  function InfoPanel(props) {
    ...
    _this.UpdateFilterSummary = _this.UpdateFilterSummary.bind(_this);
    _this.OnClearBtnClick = _this.OnClearBtnClick.bind(_this);

    UDATA = UNISYS.NewDataLink(_this);
    UDATA.HandleMessage("FILTER_SUMMARY_UPDATE", _this.UpdateFilterSummary);
  ...
  _createClass(InfoPanel, [{
    ...
    value: function handleDrag(e) {
      ...
      var top = Math.max(122, e.clientY + this.state.draggerMouseOffsetY + defaultTabPanelHeight);
      this.setState({
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          filtersSummary = _state.filtersSummary;
      ...
      return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('3');_this2.sendGA('Nodes Table', window.location);
                  }
                },
                'Nodes Table'
              )
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('4');_this2.sendGA('Edges Table', window.location);
                  }
                },
                'Edges Table'
              )
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('6');_this2.sendGA('Help', window.location);
                  }
                },
                'More...'
              )
          ...
          React.createElement(
            TabContent,
            { activeTab: activeTab, style: { height: '100%', overflow: 'hidden', backgroundColor: 'rgba(0,0,0,0.1)' } },
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Col,
                  { sm: '12' },
                  activeTab === "3" && React.createElement(NodeTable, { tableHeight: tableHeight })
                )
              )
            ),
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Col,
                  { sm: '12' },
                  activeTab === "4" && React.createElement(EdgeTable, { tableHeight: tableHeight })
                )
              )
            ),
            React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { size: 'sm', outline: true, onClick: this.OnClearBtnClick, style: { color: '#eee', borderColor: '#ddd', fontSize: '0.8em', padding: '0.1rem 0.2rem' } },
            'Clear Filters'
          )
        )
      );
...
var MarkdownNote = function (_UNISYS$Component) {
  ...
  _createClass(MarkdownNote, [{
    ...
    value: function render() {
      ...
      return React.createElement(_markdownReactJs2.default, {
        text: text,
        onIterate: this.markdownIterate,
        markdownOptions: { typographer: true, linkify: true },
        plugins: [mdplugins.emoji]
...
require.register("view/netcreate/components/More.jsx", function(exports, require, module) {
'use strict';
...
var More = function (_UNISYS$Component) {
  _inherits(More, _UNISYS$Component);
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              TabPane,
              { tabId: '1' },
              activeTab === "1" && React.createElement(Help, null)
            ),
            React.createElement(
              TabPane,
              { tabId: '2' },
              activeTab === "2" && React.createElement(Vocabulary, null)
            ),
            React.createElement(
              TabPane,
              { tabId: '3' },
              activeTab === "3" && React.createElement(ImportExport, null)
            )
          )
        )
      );
...
var NetGraph = function (_UNISYS$Component) {
  ...
  _createClass(NetGraph, [{
    ...
    value: function componentDidMount() {
      ...
      var d3NetGraph = new D3NetGraph(el, this.AppState('TEMPLATE').nodePrompts);
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { outline: true, onClick: this.onZoomIn, style: { width: '35px', backgroundColor: '#fff', opacity: '0.8' } },
            '+'
          ),
          '\xA0',
          React.createElement(
            Button,
            { outline: true, onClick: this.onZoomReset, style: { width: '35px', backgroundColor: '#fff', opacity: '0.8' } },
            '\u2022'
          ),
          '\xA0',
          React.createElement(
            Button,
            { outline: true, onClick: this.onZoomOut, style: { width: '35px', backgroundColor: '#fff', opacity: '0.8' } },
            '-'
          )
        ),
        React.createElement(
          ...
          nodeTypes.map(function (type, i) {
            return React.createElement(
              ...
              React.createElement(
                'div',
                { style: { display: 'inline-block', paddingRight: '2em', lineHeight: '10px' } },
...
var NodeSelector = function (_UNISYS$Component) {
  ...
  function NodeSelector(props) {
    ...
    UDATA.HandleMessage("NODE_EDIT", function (data) {
      if (data.nodeID !== undefined && typeof data.nodeID === "number" && !_this.state.isEditable && !_this.state.isLocked) {
  ...
  _createClass(NodeSelector, [{
    ...
    value: function requestEditNode(nodeID) {
      ...
      this.NetCall('SRV_DBLOCKNODE', { nodeID: nodeID }).then(function (data) {
        if (data.NOP) {
          ...
          _this4.setState({ dbIsLocked: true });
        } else if (data.locked) {
    ...
    value: function render() {
      ...
      var _state = this.state,
          nodePrompts = _state.nodePrompts,
          citationPrompts = _state.citationPrompts;
      ...
      return React.createElement(
        ...
        React.createElement(
          FormGroup,
          { className: 'text-right', style: { marginTop: '-20px', paddingRight: '5px' } },
          React.createElement(
            Button,
            { outline: true, size: 'sm',
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'span',
                  { className: 'tooltiptext' },
                  this.helpText(nodePrompts.label)
                )
              )
            ),
            React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'span',
                  { className: 'tooltiptext' },
                  this.helpText(nodePrompts.type)
                )
              )
            ),
            React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'span',
                  { className: 'tooltiptext' },
                  this.helpText(nodePrompts.notes)
                )
              )
            ),
            React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'span',
                  { className: 'tooltiptext' },
                  this.helpText(nodePrompts.info)
                )
              )
            ),
            React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Button,
                  { className: 'small btn btn-outline-light', size: 'sm',
        ...
        React.createElement(
          ...
          this.state.edges.map(function (edge, i) {
            return React.createElement(EdgeEditor, {
              ...
              parentNodeIsLocked: _this8.state.isLocked
            });
          }),
          React.createElement(
            FormGroup,
    ...
    value: function markdownDisplay(text) {
      ...
      if (!this.state.isEditable) return (0, _markdownReactJs.mdReact)({ onIterate: this.markdownIterate, markdownOptions: { typographer: true, linkify: true }, plugins: [mdplugins.emoji]
      })(text);
    }
  }, {
    key: 'markdownIterate',
...
var NodeTable = function (_UNISYS$Component) {
  ...
  _createClass(NodeTable, [{
    ...
    value: function componentDidMount() {
      ...
      // filtered data needs to be set before D3Data
      var FILTEREDD3DATA = UDATA.AppState('FILTEREDD3DATA');
      this.setState({ filteredNodes: FILTEREDD3DATA.nodes }, function () {
        var D3DATA = _this2.AppState('D3DATA');
        _this2.handleDataUpdate(D3DATA);
      });
    }
    ...
    value: function handleFilterDataUpdate(data) {
      ...
      if (data.nodes) {
        ...
        this.setState({ filteredNodes: filteredNodes }, function () {
          var nodes = _this3.sortTable(_this3.state.sortkey, _this3.state.nodes);
          _this3.updateNodeFilterState(nodes, filteredNodes);
        });
      }
    }
    ...
    value: function setSortKey(key) {
      ...
      var nodes = this.sortTable(key, this.state.nodes);
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("edgeCount");
                    }
                  },
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("label");
                    }
                  },
                  nodePrompts.label.label,
                  ' ',
              ...
              React.createElement(
                'th',
                { width: '10%', hidden: nodePrompts.type.hidden },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
                      return _this9.setSortKey("type");
                    }
                  },
                  nodePrompts.type.label,
                  ' ',
                  this.sortSymbol("type")
                )
              ),
              React.createElement(
                'th',
                { width: '20%', hidden: nodePrompts.info.hidden },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
              ...
              React.createElement(
                'th',
                { width: '30%', hidden: nodePrompts.notes.hidden },
                React.createElement(
                  Button,
                  { size: 'sm',
                    onClick: function onClick() {
              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'a',
                    { href: '#', onClick: function onClick(e) {
                        return _this9.selectNode(node.id, e);
                      }
                    },
                    node.label
                  )
                ...
                React.createElement(
                  ...
                  node.attributes["Notes"] ? React.createElement(MarkdownNote, { text: node.attributes["Notes"] }) : ""
                ),
                React.createElement(
                  'td',
                  { hidden: !isLocalHost },
                  _this9.displayUpdated(node)
                )
              );
            })
          )
...
var D3NetGraph = function () {
  function D3NetGraph(rootElement, nodePrompts) {
    var _this = this;
    ...
    UDATA.OnAppStateChange('FILTEREDD3DATA', function (data) {
      // expect { nodes, edges } for this namespace
    ...
    // (Currently not used)
    UDATA.HandleMessage('ZOOM_PAN_RESET', function (data) {
      if (DBG) console.log(PR, 'ZOOM_PAN_RESET got state D3DATA', data);
      var transform = d3.zoomIdentity.translate(0, 0).scale(1);
      _this.d3svg.call(_this.zoom.transform, transform);
    });

    UDATA.HandleMessage('GROUP_PROPS', function (data) {
  ...
  _createClass(D3NetGraph, [{
    ...
    value: function _UpdateGraph() {
      ...
      .text(function (d) {
        return _this2.tooltipForNode(d);
      });
      ...
      linkElements.enter().insert("line", ".node").classed('edge', true).style('stroke', this._UpdateLinkStrokeColor)
      ...
      linkElements.merge(linkElements).classed("selected", function (d) {
        return d.selected;
      }).style('stroke', this._UpdateLinkStrokeColor).style('stroke-width', this._UpdateLinkStrokeWidth).transition().duration(500).style("opacity", function (d) {
        return d.filteredTransparency;
      });
    ...
    key: 'tooltipForNode',
    value: function tooltipForNode(d) {
      var titleText = "";
      if (this.nodePrompts.label.includeInGraphTooltip != undefined) {
        // Add Label
        if (this.nodePrompts.label.includeInGraphTooltip) titleText += this.nodePrompts.label.label + ": " + d.label + "\n";
        // Add type
        if (this.nodePrompts.type.includeInGraphTooltip) titleText += this.nodePrompts.type.label + ": " + d.attributes.Node_Type + "\n";
        // Add degrees
        if (this.nodePrompts.degrees.includeInGraphTooltip) titleText += this.nodePrompts.degrees.label + ": " + d.weight + "\n";
        // Add notes
        if (this.nodePrompts.notes.includeInGraphTooltip) titleText += this.nodePrompts.notes.label + ": " + d.attributes.Notes + "\n";
        // Add info
        if (this.nodePrompts.info.includeInGraphTooltip) titleText += this.nodePrompts.info.label + ": " + d.attributes["Extra Info"] + "\n";
        // Add updated info
        if (this.nodePrompts.updated.includeInGraphTooltip) titleText += this.nodePrompts.updated.label + ": " + this.displayUpdated(d);
      } else {
    ...
    key: '_UpdateLinkStrokeColor',
    value: function _UpdateLinkStrokeColor(edge) {
      var COLORMAP = UDATA.AppState('NODECOLORMAP');
      var color = COLORMAP[edge.attributes.Relationship];
      return color;
    }
...
require.register("view/netcreate/components/filter/FilterGroup.jsx", function(exports, require, module) {
'use strict';
...
var _FilterGroupProperties = require('./FilterGroupProperties');

var _FilterGroupProperties2 = _interopRequireDefault(_FilterGroupProperties);
...
function FilterGroup(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'filter-group', style: { margin: '5px 5px 5px 0', padding: '10px', backgroundColor: 'rgba(0,0,0,0)' } },
    _react2.default.createElement(
      'div',
      { className: 'small text-muted', style: { fontWeight: 'bold', textTransform: 'uppercase', marginBottom: '0.4em' } },
      label
    ),
    filters.map(function (filter) {
      switch (filter.type) {
        ...
        case _FilterEnums2.default.TYPES.NODE:
          return _react2.default.createElement(_StringFilter2.default, { key: filter.id, group: group, filter: filter, filterAction: filterAction });
          break;
        case _FilterEnums2.default.TYPES.NUMBER:
          return _react2.default.createElement(_NumberFilter2.default, { key: filter.id, group: group, filter: filter, filterAction: filterAction });
          break;
        case _FilterEnums2.default.TYPES.SELECT:
          return _react2.default.createElement(_SelectFilter2.default, { key: filter.id, group: group, filter: filter, filterAction: filterAction });
          break;
        default:
    ...
    _react2.default.createElement(_FilterGroupProperties2.default, { group: group, transparency: transparency }),
...
;require.register("view/netcreate/components/filter/FilterGroupProperties.jsx", function(exports, require, module) {
'use strict';
...
var FilterGroupProperties = function (_React$Component) {
  _inherits(FilterGroupProperties, _React$Component);
  ...
  function FilterGroupProperties(_ref) {
    var group = _ref.group,
        transparency = _ref.transparency;

    _classCallCheck(this, FilterGroupProperties);

    var _this = _possibleConstructorReturn(this, (FilterGroupProperties.__proto__ || Object.getPrototypeOf(FilterGroupProperties)).call(this));
  ...
  _createClass(FilterGroupProperties, [{
    key: 'OnChangeValue',
    ...
    value: function TriggerChangeHandler() {
      // for debugging
    ...
    value: function render() {
      var _props = this.props,
          group = _props.group,
          transparency = _props.transparency;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          Form,
          { inline: true, className: 'filter-item', key: group, onSubmit: this.OnSubmit },
          _react2.default.createElement(
            FormGroup,
            null,
            _react2.default.createElement(
              Label,
              { size: 'sm', className: 'small text-muted',
                style: { fontSize: '0.75em', lineHeight: '1em', width: '5em', marginLeft: '0em' } },
              'Transparency\xA0'
            ),
            _react2.default.createElement(Input, { type: 'text', value: transparency,
...
exports.default = FilterGroupProperties;

});

require.register("view/netcreate/components/filter/FiltersPanel.jsx", function(exports, require, module) {
'use strict';
...
var FiltersPanel = function (_UNISYS$Component) {
  _inherits(FiltersPanel, _UNISYS$Component);
  ...
  function FiltersPanel(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (FiltersPanel.__proto__ || Object.getPrototypeOf(FiltersPanel)).call(this));

    _this.UpdateFilterDefs = _this.UpdateFilterDefs.bind(_this);
    _this.OnClearBtnClick = _this.OnClearBtnClick.bind(_this);
    _this.SelectFilterAction = _this.SelectFilterAction.bind(_this);
    ...
    var FDATA = UDATA.AppState("FDATA");
    _this.state = {
      nodes: FDATA.nodes,
      edges: FDATA.edges,
      filterAction: _FilterEnums2.default.ACTION.HIGHLIGHT
    };
    UDATA.OnAppStateChange("FDATA", _this.UpdateFilterDefs);
    return _this;
  } // constructor
  ...
  _createClass(FiltersPanel, [{
    ...
    key: 'UpdateFilterDefs',
    value: function UpdateFilterDefs(data) {
      this.setState(function (state) {
        return {
          nodes: data.nodes,
          edges: data.edges,
    ...
    key: 'SelectFilterAction',
    value: function SelectFilterAction(filterAction) {
    ...
    value: function render() {
      ...
      var filterAction = this.state.filterAction;

      var defs = [this.state.nodes, this.state.edges];
      return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            {
              onClick: function onClick() {
                return _this2.SelectFilterAction(_FilterEnums2.default.ACTION.HIGHLIGHT);
              },
              active: filterAction === _FilterEnums2.default.ACTION.HIGHLIGHT,
              outline: filterAction === _FilterEnums2.default.ACTION.HIGHLIGHT,
              disabled: filterAction === _FilterEnums2.default.ACTION.HIGHLIGHT,
              style: {
                color: filterAction === _FilterEnums2.default.ACTION.HIGHLIGHT ? '#333' : '#fff',
                backgroundColor: filterAction === _FilterEnums2.default.ACTION.HIGHLIGHT ? 'transparent' : '#6c757d88'
              }
            },
            'Highlight'
          ),
          _react2.default.createElement(
            ...
            {
              onClick: function onClick() {
                return _this2.SelectFilterAction(_FilterEnums2.default.ACTION.FILTER);
              },
              active: filterAction === _FilterEnums2.default.ACTION.FILTER,
              outline: filterAction === _FilterEnums2.default.ACTION.FILTER,
              disabled: filterAction === _FilterEnums2.default.ACTION.FILTER,
              style: {
                color: filterAction === _FilterEnums2.default.ACTION.FILTER ? '#333' : '#fff',
                backgroundColor: filterAction === _FilterEnums2.default.ACTION.FILTER ? 'transparent' : '#6c757d88'
              }
            },
            'Filter'
          )
        ...
        _react2.default.createElement(
          Label,
          { className: 'small text-muted', style: { padding: '0.5em 0 0 0.5em', marginBottom: '0' } },
          filterAction === _FilterEnums2.default.ACTION.HIGHLIGHT ? 'Highlight nodes/edges that match criteria. (Fade others)' : 'Filter shows only nodes/edges that match criteria.  (Removes others)'
        ),
        _react2.default.createElement('hr', null),
        _react2.default.createElement(
          'div',
          ...
          defs.map(function (def) {
            return _react2.default.createElement(_FilterGroup2.default, {
              key: def.label,
              group: def.group,
              label: def.label,
              filters: def.filters,
              ...
              onFiltersChange: _this2.OnFilterChange
            });
          })
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            Button,
            { size: 'sm', onClick: this.OnClearBtnClick },
            'Clear Filters'
          )
        )
      );
...
require.register("view/netcreate/components/filter/NumberFilter.js", function(exports, require, module) {
'use strict';
...
var OPERATORS = [_FilterEnums2.default.OPERATORS.NO_OP, _FilterEnums2.default.OPERATORS.GT, _FilterEnums2.default.OPERATORS.GT_EQ, _FilterEnums2.default.OPERATORS.LT, _FilterEnums2.default.OPERATORS.LT_EQ, _FilterEnums2.default.OPERATORS.EQ, _FilterEnums2.default.OPERATORS.NOT_EQ];
...
var NumberFilter = function (_React$Component) {
  ...
  function NumberFilter(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (NumberFilter.__proto__ || Object.getPrototypeOf(NumberFilter)).call(this));

    _this.OnChangeOperator = _this.OnChangeOperator.bind(_this);
    _this.OnChangeValue = _this.OnChangeValue.bind(_this);
    _this.TriggerChangeHandler = _this.TriggerChangeHandler.bind(_this);
    _this.OnSubmit = _this.OnSubmit.bind(_this);

    _this.state = {
      operator: _FilterEnums2.default.OPERATORS.NO_OP, // Used locally to define result
  ...
  _createClass(NumberFilter, [{
    ...
    value: function OnChangeOperator(e) {
      this.setState({
    ...
    key: 'TriggerChangeHandler',
    value: function TriggerChangeHandler() {
      var filterAction = this.props.filterAction;
      var _props$filter = this.props.filter,
          id = _props$filter.id,
          type = _props$filter.type,
          key = _props$filter.key,
          keylabel = _props$filter.keylabel;
    ...
    value: function render() {
      var filterAction = this.props.filterAction;
      var _props$filter2 = this.props.filter,
          id = _props$filter2.id,
          key = _props$filter2.key,
          keylabel = _props$filter2.keylabel,
          operator = _props$filter2.operator,
          value = _props$filter2.value;

      return _react2.default.createElement(
        Form,
        { inline: true, className: 'filter-item', key: id, onSubmit: this.OnSubmit },
        _react2.default.createElement(
          FormGroup,
          ...
          _react2.default.createElement(
            Input,
            { type: 'select', value: operator,
              style: { maxWidth: '12em', height: '1.5em', padding: '0' },
              onChange: this.OnChangeOperator, bsSize: 'sm' },
            OPERATORS.map(function (op) {
              return _react2.default.createElement(
                'option',
                { value: op.key, key: '' + id + op.key, size: 'sm' },
                op.label
              );
            })
          ),
          _react2.default.createElement(Input, { type: 'text', value: value, placeholder: '...',
            style: { maxWidth: '12em', height: '1.5em', padding: '0' },
            onChange: this.OnChangeValue, bsSize: 'sm',
...
require.register("view/netcreate/components/filter/SelectFilter.js", function(exports, require, module) {
'use strict';
...
var SelectFilter = function (_React$Component) {
  ...
  function SelectFilter(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (SelectFilter.__proto__ || Object.getPrototypeOf(SelectFilter)).call(this));
  ...
  _createClass(SelectFilter, [{
    ...
    value: function render() {
      ...
      var _props$filter2 = this.props.filter,
          ...
          operator = _props$filter2.operator,
          value = _props$filter2.value,
          options = _props$filter2.options;
...
require.register("view/netcreate/components/filter/StringFilter.jsx", function(exports, require, module) {
'use strict';
...
var StringFilter = function (_React$Component) {
  ...
  function StringFilter(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (StringFilter.__proto__ || Object.getPrototypeOf(StringFilter)).call(this));
...
require.register("view/netcreate/export-logic.js", function(exports, require, module) {
'use strict';
...
var NODEKEYS = ['id', 'label', { 'attributes': ['Node_Type', 'Extra Info', 'Notes'] }, 'degrees', { 'meta': ['created', 'updated'] }];
...
var EDGEKEYS = ['id', 'source', 'target', { 'attributes': ['Relationship', 'Info', 'Citations', 'Category', 'Notes'] }, { 'meta': ['created', 'updated'] }];
...
function m_GenerateNodesArray(nodes, nodekeys) {
  ...
  nodes.forEach(function (n) {
    return nodesArr.push(m_getNodeValues(n, nodekeys));
  });
  return nodesArr;
}
...
function m_GenerateEdgesArray(edges, edgekeys) {
  ...
  edges.forEach(function (e) {
    return edgeArr.push(m_getEdgeValues(e, edgekeys));
  });
  return edgeArr;
}
...
MOD.ExportNodes = function () {
  var DATA = UDATA.AppState('FILTEREDD3DATA');
  var nodes = DATA.nodes;
  ...
  var nodeHeadersArr = NODEKEYS.map(function (key) {
    // eslint-disable-next-line prefer-reflect
    if (Object.prototype.toString.call(key) === '[object Object]') {
      var subKeys = Object.keys(key); // can have multiple subKeys
      var internalkeys = subKeys.map(function (sk) {
        return key[sk].map(function (k) {
          return sk + ':' + k;
        });
      }).flat();
      return internalkeys.map(function (k) {
        return NODEKEY_LABELS[k];
      });
    } else {
...
MOD.ExportEdges = function () {
  ...
  ///   3.1. EDGES
  ///   3.1.1. Create headers
  var edgeHeadersArr = EDGEKEYS.map(function (key) {
    // eslint-disable-next-line prefer-reflect
    if (Object.prototype.toString.call(key) === '[object Object]') {
      var subKeys = Object.keys(key); // can have multiple subKeys
      return subKeys.map(function (sk) {
        return key[sk].map(function (k) {
          return sk + ':' + k;
        });
      }).flat();
...
require.register("view/netcreate/filter-logic.js", function(exports, require, module) {
"use strict";
...
var _FilterEnums = require("./components/filter/FilterEnums");
...
var HACKMAP_NODES = { // Map to convert old 'attributes' data formats.
  type: "Node_Type", // Used in m_IsNodeMatchedByFilter
  info: "Extra Info",
  notes: "Notes"
};
var HACKMAP_EDGES = { // Map to convert old 'attributes' data formats.
  ...
  UDATA.OnAppStateChange("FDATA", function (data) {
...
function m_ImportPrompts(prompts) {
  ...
  try {
    for (var _iterator = Object.entries(prompts)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      switch (prompt.type) {
        case _FilterEnums2.default.TYPES.STRING:
          operator = _FilterEnums2.default.OPERATORS.NO_OP.key; // default to no_op
          break;
        case _FilterEnums2.default.TYPES.NUMBER:
          operator = _FilterEnums2.default.OPERATORS.NO_OP.key; // default to no_op
          break;
        ...
        case _FilterEnums2.default.TYPES.NODE:
          operator = _FilterEnums2.default.OPERATORS.NO_OP.key; // default to no_op
          break;
        case _FilterEnums2.default.TYPES.DATE:
          operator = _FilterEnums2.default.OPERATORS.NO_OP.key; // default to no_op
          break;
        case _FilterEnums2.default.TYPES.HIDDEN:
          break;
        default:
      ...
      if (prompt.type === _FilterEnums2.default.TYPES.SELECT) {
        (function () {
          var options = [];
...
function m_FilterDefine(data) {
  ...
  if (data.group === "nodes") {
    ...
    if (data.type === "transparency") {
      ...
      var nodeFilters = FDATA.nodes.filters;
    ...
    if (data.type === "transparency") {
      ...
      var edgeFilters = FDATA.edges.filters;
...
function m_FiltersApply() {
  var FILTEREDD3DATA = UDATA.AppState("D3DATA");
  var FDATA = UDATA.AppState("FDATA");
...
function m_UpdateFilterSummary() {
  ...
  var typeSummary = FDATA.filterAction === _FilterEnums2.default.ACTION.HIGHLIGHT ? 'HIGHLIGHTING ' : 'FILTERING ';
  var nodeSummary = m_FiltersToString(FDATA.nodes.filters);
  var edgeSummary = m_FiltersToString(FDATA.edges.filters);
  var summary = '';
  if (nodeSummary || edgeSummary) summary = typeSummary + " " + (nodeSummary ? 'NODES: ' : '') + nodeSummary + " " + (edgeSummary ? 'EDGES: ' : '') + edgeSummary;
...
function m_FiltersToString(filters) {
  ...
  filters.forEach(function (filter) {
    if (filter.operator === undefined || filter.value === undefined || filter.value === '') return;
...
function m_OperatorToString(operator) {
  return _FilterEnums2.default.OPERATORS[operator].label;
}
...
function m_MatchNumber(operator, filterVal, objVal) {
  ...
  if (filterVal === "") {
    ...
    switch (operator) {
      case _FilterEnums2.default.OPERATORS.GT.key:
        matches = objVal > filterVal;
        break;
      case _FilterEnums2.default.OPERATORS.GT_EQ.key:
        matches = objVal >= filterVal;
        break;
      case _FilterEnums2.default.OPERATORS.LT.key:
        matches = objVal < filterVal;
        break;
      case _FilterEnums2.default.OPERATORS.LT_EQ.key:
        matches = objVal <= filterVal;
        break;
      case _FilterEnums2.default.OPERATORS.EQ.key:
        matches = objVal === filterVal;
        break;
      case _FilterEnums2.default.OPERATORS.NOT_EQ.key:
        matches = objVal !== filterVal;
        break;
      default:
...
function m_FiltersApplyToNodes(FDATA, FILTEREDD3DATA) {
  var filterAction = FDATA.filterAction;
  var _FDATA$nodes = FDATA.nodes,
      filters = _FDATA$nodes.filters,
      transparency = _FDATA$nodes.transparency;

  FILTEREDD3DATA.nodes = FILTEREDD3DATA.nodes.filter(function (node) {
...
function m_NodeIsFiltered(node, filters, transparency, filterAction) {
  ...
  filters.forEach(function (filter) {
    if (filter.operator === _FilterEnums2.default.OPERATORS.NO_OP.key) return; // skip no_op
    // all_no_op = false;
  ...
  if (filterAction === _FilterEnums2.default.ACTION.FILTER) {
...
function m_IsNodeMatchedByFilter(node, filter) {
  ...
  switch (filter.operator) {
    case _FilterEnums2.default.OPERATORS.CONTAINS.key:
      return m_MatchString(filter.value, nodeValue, true);
      break;
    case _FilterEnums2.default.OPERATORS.NOT_CONTAINS.key:
...
function m_FiltersApplyToEdges(FDATA, FILTEREDD3DATA) {
  var filterAction = FDATA.filterAction;
  var _FDATA$edges = FDATA.edges,
      filters = _FDATA$edges.filters,
      transparency = _FDATA$edges.transparency;

  FILTEREDD3DATA.edges = FILTEREDD3DATA.edges.filter(function (edge) {
...
function m_EdgeIsFiltered(edge, filters, transparency, filterAction, FILTEREDD3DATA) {
  ...
  var keepEdge = true;
  var source = FILTEREDD3DATA.nodes.find(function (e) {
  ...
  var target = FILTEREDD3DATA.nodes.find(function (e) {
  ...
  if (source === undefined || target === undefined || source.filteredTransparency < 1.0 || target.filteredTransparency < 1.0) {
    // regardless of filter definition...
    // ...if filterAction is FILTER
    // always hide edge if it's attached to a filtered node
    if (filterAction === _FilterEnums2.default.ACTION.FILTER) return false;
...
function m_IsEdgeMatchedByFilter(edge, filter) {
  ...
  if (filter.type === _FilterEnums2.default.TYPES.NODE) {
...
var JSCLI = require("system/util/jscli");
var D3 = require("d3");
var EXPORT = require("./export-logic");
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return DATASTORE.PromiseJSONFile("data/" + dataset + "-db.json").then(function (data) {
                  m_ConvertData(data);
              ...
              case 2:
                p1 = _context.sent;
                _context.next = 5;
                return DATASTORE.PromiseJSONFile("data/" + dataset + "-template.json").then(function (data) {
                  TEMPLATE = data;
                  UDATA.SetAppState("TEMPLATE", TEMPLATE);
                });
...
MOD.Hook("CONFIGURE", function () {
  ...
  try {
    ...
    if (edgePrompts.category === undefined) throw "Missing `edgePrompts.category` info=" + edgePrompts.category;
  } catch (error) {
  ...
  try {
    ...
    var defaultEdgeColor = TEMPLATE.edgePrompts.color || "#999"; //for backwards compatability
    TEMPLATE.edgePrompts.type.options.forEach(function (o) {
...
MOD.Hook("INITIALIZE", function () {
  ...
  UDATA.OnAppStateChange("SEARCH", function (stateChange) {
    ...
    if (nodes !== undefined) {
      if (nodes.length > 0) {
        var color = TEMPLATE.searchColor != undefined ? TEMPLATE.searchColor : DEFAULT_SEARCH_COLOR;
        nodes.forEach(function (node) {
  ...
  /*/
  /*/
  UDATA.HandleMessage("EXPORT_NODES", function (data) {
    EXPORT.ExportNodes();
  });
  UDATA.HandleMessage("EXPORT_EDGES", function (data) {
    EXPORT.ExportEdges();
  });
}); // end UNISYS_INIT
...
function m_MarkNodeById(id, color) {
  var marked = { selected: TEMPLATE.sourceColor != undefined ? TEMPLATE.sourceColor : DEFAULT_SOURCE_COLOR };
...
JSCLI.AddFunction(function ncMakeTokens(clsId, projId, dataset, numGroups) {
  ...
  if (typeof dataset !== "string") return "args: str classId, str projId, str dataset, int numGroups";
